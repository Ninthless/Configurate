...
public class TypeSerializerCollection {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> TypeSerializerCollection registerPredicate(Predicate<TypeToken<T>> test,
    ...
    public TypeSerializerCollection and(TypeSerializerCollection collection) {

        final TypeSerializerCollection toReturn = TypeSerializers.newCollection();
