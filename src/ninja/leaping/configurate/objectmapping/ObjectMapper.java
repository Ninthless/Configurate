...
public class ObjectMapper<T> {
     ...
     */
    public static <T> ObjectMapper<T> forClass(@NotNull Class<T> clazz) throws ObjectMappingException {
    ...
    public static <T> ObjectMapper<T>.BoundInstance forObject(@NotNull T obj) throws ObjectMappingException {
